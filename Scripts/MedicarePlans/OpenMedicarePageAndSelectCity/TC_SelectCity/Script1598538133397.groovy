...
try{
//WebUI.verifyElementPresent(findTestObject('Medicare Plans/OpenMedicareWebPage/Favourites'), 10)
WebUI.verifyElementPresent(findTestObject('Medicare Plans/OpenMedicareWebPage/Favourites'), 10, FailureHandling.STOP_ON_FAILURE)
}
catch (Exception e){
}